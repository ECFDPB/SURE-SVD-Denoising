...
Noise levels: sigma = 10, 20, 30, 50
"""
import numpy as np
import json
import os
...
psnr_em   = mat['psnr_results'][:, :, 1]   # (12, 4)
...
psnr_bm3d = np.zeros((12, 4))
ssim_bm3d = np.zeros((12, 4))
psnr_ksvd = np.zeros((12, 4))
ssim_ksvd = np.zeros((12, 4))
...
n_rows = 12 * 4 + 1  # 48 data rows + 1 average row
